...
require 'finicity/v1/request/add_accounts'
...
require 'finicity/v1/request/get_customer_by_id'
require 'finicity/v1/request/get_institution_by_id'
require 'finicity/v1/request/get_institutions'
require 'finicity/v1/request/get_all_institutions'
